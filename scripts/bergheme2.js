...
function bergheme_main() {
  ...
  //          backgroundImage: 'url("assets/pictures/old_paper_texture_.png")',
		...
		.append('<img id="background" alt="background" src="" style="position: absolute"; />')
        .append($('<div>').css('position', 'absolute').append(
			'A Christmas Wish<br><br>' +
...
//	$('#landscape_pic').append('<img id="background" alt="background" src="" />');
...
/*
	...
	function run() {
		...
		image.onload = function() {
			...
			var engine = new RainyDay({
				image: this,
				parentElement: document.getElementById('landscape_pic')
			});
	...
	$('#landscape_pic').append($('<div>').css('position', 'absolute').append(
			'A Christmas Wish<br><br>' +
            'I\'d like a stocking made for a giant,<br>' +
            'And a meeting house full of toys,<br>' +
            'Then I\'d go out in a happy hunt<br>' +
